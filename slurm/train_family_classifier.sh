#!/bin/bash
#SBATCH --job-name=dima-family-cg-650m
...
#SBATCH --output=logs/dima_family_cg_%j.out
#SBATCH --error=logs/dima_family_cg_%j.err

# ============================================================
# Family-Specific Classifier Guidance - ESM-650M on Leonardo HPC
# §3.6.2: Classifier Guidance approach
# ============================================================
...
echo "Starting family-specific classifier guidance with ESM-650M..."
...
torchrun \
    ...
    pixi run -e dima-env python train_family.py \
        ...
        project.wandb_project=dima-family-cg \
        ddp.enabled=true \
        ...
        classifier.training_iters=300 \
        classifier.batch_size=1024 \
